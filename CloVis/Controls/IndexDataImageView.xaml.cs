...
namespace CloVis.Controls
{
    public sealed partial class IndexDataImageView : UserControl, INotifyPropertyChanged
    {
        ...
        private async static void OnImageChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            {
                instance.Img.Source = await ResumeElements.FileManagement.Images.GetImageSourceAsync(instance.Image.Value);
        ...
        public async void Delete_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (temp == ResumeElements.FileManagement.ImageRemovedOutput.RestoredToDefault)
            {
                Img.Source = await ResumeElements.FileManagement.Images.GetImageSourceAsync(Image.Value);
            ...
            else if (temp == ResumeElements.FileManagement.ImageRemovedOutput.NothingDone)
            {
                var f = new Flyout()
                {
        ...
        {
            var temp = await ResumeElements.FileManagement.Images.GetPicker().PickSingleFileAsync();
